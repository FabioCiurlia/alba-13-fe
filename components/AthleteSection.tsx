    ...
    return (
        <div className="group relative flex flex-col cursor-pointer">
            ...
            <div className="mt-4 space-y-1">
                ...
                <div className="inline-block px-2 py-0.5 bg-slate-200  group-hover:bg-cyan-100 transition-colors duration-300">
    ...
    return (
        visible && <AnimatedLink to={`/${slug}/athletes`}>
            <div className="group relative flex flex-col cursor-pointer h-full">
                {/* Square Wrapper */}
                <div className="relative aspect-square overflow-hidden rounded-2xl bg-slate-900 flex flex-col items-center justify-center transition-all duration-500 hover:bg-slate-800">
